...
// 20 chủ đề với tên tiếng Việt và tiếng Anh
const categories = [
...
// Dữ liệu câu nói: mỗi chủ đề 5 câu
const sentencesData: {
...
async function main() {
  ...
  // Tạo các chủ đề
  const createdCategories: Array<{ id: number; name_vi: string | null; name_en: string | null }> = [];
